...
{
    [AddIn("DeviceInfo", Version = "1.0.0.0", Publisher = "zhenhua.mao", Description = "获取设备属性")]
    public class HuaweiAddIn_PutDev : IRibbonMenuAV
    {
        ...
        {
            _Host = host;
            host.AppendRibbonMenu("Huawei", "在FLD中添加设备并连接", null, null);
        }
        ...
        public void OnMenuInvoked(object tag)
        {
            ...
            if (activeControl != null)
            {
                ...
                if (fldView != null)
                {
                    ...
                    //获取信源模版
                    List<TemplateLine> srcTemplate = LayoutObject.GetTemplateListByDeviceType(DeviceTypeNew.Source);
                    ...
                    //添加信源与添加其他普通设备一样
                    //使用系统模版来添加信源
                    LayoutDevice layoutDevice1 = PutDevice(fldView, srcTemplate[0].Name, 0, 0, 2.4f);
