...
{
    [AddIn("HuaweiReportAddIn", Version = "1.0.0.0", Publisher = "zhenhua.mao", Description = "测试插入设备，然后使用线缆连接并且要求线缆经过指定的关键点")]
    public class HuaweiImportTestAddIn : IRibbonMenuAV
    {
        ...
        {
            _Host = host;
            host.AppendRibbonMenu("Huawei", "TestImportDev", null, null);
        }
